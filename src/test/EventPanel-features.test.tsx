/**
 * EventPanel Tests — Part 3 (Time input + Delete)
...
describe('EventPanel — Features', () => {
  const onClose = vi.fn();
  beforeEach(() => { vi.clearAllMocks(); });

  it('renders time input fields and duration presets', () => {
  ...
  it('shows delete button only in edit mode', () => {
    const { unmount } = render(<EventPanel eventId={null} date="2026-02-10" onClose={onClose} />, { wrapper: createWrapper() });
