/**
 * BillPanel Tests — Part 2 (Edit mode + Cancel)
...
describe('BillPanel — Edit & Cancel', () => {
  const onClose = vi.fn();
  beforeEach(() => { vi.clearAllMocks(); });

  it('populates form with bill data in edit mode', () => {
    render(<BillPanel billId={1} date="2026-02-10" onClose={onClose} />, { wrapper: createWrapper() });
